        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Designing, building, and optimizing scalable ETL/ELT pipelines.
                Designing automated incremental loads and streaming ingestion for real-time analytics.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Cloud-Native Data Platforms</h4>
              <p>
                Building Medallion Architecture data lakes and dimensional modeling for cloud
                data warehouses, ensuring secure data access and governance.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">ADLS Gen2</div>
